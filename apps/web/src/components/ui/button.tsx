...
// Class strings verbatim from Dinghy components/ui/button.tsx. Stock heights
// (h-10/h-9/size-10/size-9) are tightened by the [data-size] overrides in styles.css.
