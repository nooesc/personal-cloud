/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: efc19bf22bb3f4f98bd135e7f745b8f3)
...
interface __BaseEnv_CloudflareEnv {
	...
	UPLOADS: DurableObjectNamespace<import("./src/index").RegistryUpload>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Workspace" | "RegistryUpload";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_URL" | "MAX_MACHINES_PER_WORKSPACE" | "MAX_PROJECTS_PER_WORKSPACE">> {}
}
declare module "*.sh" {
	const value: string;
