...
for port in (4310,4311):
    with socket.socket() as sock:
        ...
        except OSError: raise SystemExit(f'Port {port} is in use. Stop the existing Personal Cloud process before starting another.')
PY
